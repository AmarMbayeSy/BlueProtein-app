...
<body>
    ...
    <section class="images position-relative" style="height: 500px;">
        <div class="row h-100">
            <div class="h-100">
                <img src="./immmmage/collectif.jpeg" class="d-block w-100 h-100 object-fit-cover" alt="...">
                <div class="fixed-text">
                    <span class="image-text" style="color: rgb(251, 239, 239); font-size: 4rem;">Collectivité</span>
                </div>
            </div>
        </div>
    </section>
